...
public class AccessPoint_ implements Comparable {
    ...
    public AccessPoint_(Context context, WifiConfiguration config) {
        mContext = context;
        loadConfig(config);
        refresh();
    }

    public AccessPoint_(Context context, ScanResult result) {
        mContext = context;
        loadResult(result);
        refresh();
    }

    public AccessPoint_(Context context, Bundle savedState) {
        mContext = context;
...
//    }
    ...
    public int compareTo(Object o) {
        AccessPoint_ other = (AccessPoint_) o;
    ...
    public boolean equals(Object other) {
        if (!(other instanceof AccessPoint_)) return false;
        return (this.compareTo((AccessPoint_) other) == 0);
    }
...
//        }
    ...
    public void generateOpenNetworkConfig() {
        ...
        mConfig.SSID = AccessPoint_.convertToQuotedString(ssid);
