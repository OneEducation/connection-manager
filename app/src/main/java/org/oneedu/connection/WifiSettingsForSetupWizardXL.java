...
public class WifiSettingsForSetupWizardXL extends Activity implements OnClickListener {
     ...
     *
     * Note that we don't use original {@link android.net.NetworkInfo.DetailedState} object but simplified one translated
     ...
     * {@link android.net.wifi.WifiManager#SUPPLICANT_STATE_CHANGED_ACTION}.
     */
