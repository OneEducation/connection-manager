...
public class AP implements Comparable {
    ...
    AP(WifiConfiguration config) {
        loadConfig(config);
        refresh();
    }

    AP(ScanResult result) {
        loadResult(result);
        refresh();
    }

    AP(Bundle savedState) {
        ...
        mInfo = (android.net.wifi.WifiInfo) savedState.getParcelable(KEY_WIFIINFO);
    ...
    public boolean equals(Object other) {
        ...
        return (this.compareTo((AP) other) == 0);
    }
    ...
    void update(android.net.wifi.WifiInfo info, NetworkInfo.DetailedState state) {
