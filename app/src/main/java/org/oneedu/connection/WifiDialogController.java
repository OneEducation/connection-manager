...
/**
 * The class for allowing UIs like {@link org.oneedu.connection.WifiDialog} and {@link org.oneedu.connection.WifiConfigUiBase} to
        ...
        ViewTreeObserver.OnGlobalFocusChangeListener
{
    ...
    //private final CompoundButton mSBProxy;
...
//        }
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.show_password) {
            updatePasswordVisibility((TextView)view, ((CheckBox) view).isChecked());
