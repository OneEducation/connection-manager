...
public class WifiEnabler implements CompoundButton.OnCheckedChangeListener  {
    ...
    private OnUpdateWifiStateListener mOnWifiStateListener;
    public interface OnUpdateWifiStateListener {
        abstract void onUpdateWifiState(int state);
    }
    ...
    public WifiEnabler(Context context, CompoundButton switch_, OnUpdateWifiStateListener onUpdateWifiStateListener) {
        mContext = context;
        mSwitch = switch_;

        mWifiManager = Wifi.getWifiManager(mContext);
        mIntentFilter = new IntentFilter(WifiManager.WIFI_STATE_CHANGED_ACTION);
        // The order matters! We really should not depend on this. :(
        mIntentFilter.addAction(WifiManager.SUPPLICANT_STATE_CHANGED_ACTION);
        mIntentFilter.addAction(WifiManager.NETWORK_STATE_CHANGED_ACTION);

        mOnWifiStateListener = onUpdateWifiStateListener;
    }
    ...
    public boolean isRadioAllowed(Context context, String type) {
    ...
    private void handleWifiStateChanged(int state) {
        ...
        if (mOnWifiStateListener != null) {
            mOnWifiStateListener.onUpdateWifiState(state);
        }
