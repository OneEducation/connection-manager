...
import org.oneedu.connection.BuildConfig;
import org.oneedu.connection.services.InstallerService;
...
public class PackageReceiver extends BroadcastReceiver {
    ...
    private void checkAppUniverse(Context context) {
        ...
        intent.setComponent(new ComponentName("org.oneedu.connection", "org.oneedu.connection.services.InstallerService"));
