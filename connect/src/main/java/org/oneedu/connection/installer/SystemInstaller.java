...
public class SystemInstaller extends Installer {
    ...
    protected void installPackageInternal(File apkFile) throws AndroidNotCompatibleException {
        ...
        try {
            mInstallMethod.invoke(mPm, packageURI, mInstallObserver, INSTALL_REPLACE_EXISTING, "org.oneedu.appuniverse");
        } catch (Exception e) {
            throw new AndroidNotCompatibleException(e);
        }
    }
    ...
    @Override
    protected void installPackageInternal(String uri) throws AndroidNotCompatibleException {
     ...
     * {@link #installPackage(Uri, IPackageInstallObserver, int)} on
     * success.
     */
