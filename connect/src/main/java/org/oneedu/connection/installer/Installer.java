...
package org.oneedu.connection.installer;
...
//import org.oneedu.appuniverse.Preferences;
...
abstract public class Installer {
    ...
    public static Installer getActivityInstaller(Activity activity, PackageManager pm,
        ...
        boolean isSystemInstallerEnabled = true; //Preferences.get().isSystemInstallerEnabled();
    ...
    public void installPackage(String uri) throws AndroidNotCompatibleException {
        // check if file exists...
        installPackageInternal(uri);
    }
    ...
    protected abstract void installPackageInternal(String uri)
            throws AndroidNotCompatibleException;
